    ...
    <div class="container">
        ...
        <div class="logcontainer">
            ...
            <form class="login" method="post" action="">
                <p> Username : <input class="login" type="text" name="login" value="" /></p>
                <p> Password: <input class="login" type="password" name="password" value="" /></p>
                <p class="remember_me">
                    <label>
			...
			<form class="login" method="post" action="DTsignupPage.html">
					<p class="submit"><input type="submit" name="register" value="Sign up" /></p>
			</form>
        </div>
